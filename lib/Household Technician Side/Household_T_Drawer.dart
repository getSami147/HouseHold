...
import '../Household User Side/Household_Contect US .dart';
import '../utils/Constant.dart';
import '../utils/Widget.dart';

class T_Drawerpage extends StatelessWidget {
  const T_Drawerpage({Key? key}) : super(key: key);
              ...
              children: [
                ...
                buid_Drawer_Label(
                  ...
                  onpress: () {
                    auth
                        .signOut()
                        .then((value) => SplashScreen().launch(context))
                        .onError((error, stackTrace) =>
                            utils().toastMethod(errorMessage.toString()));
                  },
                ),
              ],
