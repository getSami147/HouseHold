...
//   mList.add(CategoryModel("HouseHold", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Grocery", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Liquor", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Chilled", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Beverages", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Pharmacy", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Frozen Food", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Vegetables", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Meat", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Fish", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Homeware", ImageConstant.grocery_img_fruits));
//   mList.add(CategoryModel("Fruits", ImageConstant.grocery_img_fruits));
//   return mList;
// }
